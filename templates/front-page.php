	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main" role="main">
			...
			if ( is_array( $sticky_posts ) ) {
				$sticky_count   = absint( count( $sticky_posts ) );
				$posts_per_page = $sticky_count >= $posts_per_page ? 0 : $posts_per_page - $sticky_count;
			}

			// Blog Posts Query.
			$blog_content = new WP_Query( apply_filters( 'sanse_blog_posts_arguments', [
				'post_type'              => 'post',
